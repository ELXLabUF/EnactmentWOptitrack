...
public class Character : MonoBehaviour {
    ...
    void Start () {
        ...
        ik.solver.bodyEffector.target = GameObject.Find("Torso_RB").transform;
        ik.solver.bodyEffector.positionWeight = 1;
        ik.solver.rightHandEffector.target = GameObject.Find("RightHand_RB").transform;
        ik.solver.rightHandEffector.positionWeight = 1;
        ik.solver.leftHandEffector.target = GameObject.Find("LeftHand_RB").transform;
        ik.solver.leftHandEffector.positionWeight = 1;
        ik.solver.rightFootEffector.target = GameObject.Find("RightFoot_RB").transform;
        ik.solver.rightFootEffector.positionWeight = 1;
        ik.solver.leftFootEffector.target = GameObject.Find("LeftFoot_RB").transform;
	...
	void Update () {
        ...
        rotationVector.y = GameObject.Find("Torso_RB").transform.rotation.eulerAngles.y;
        this.gameObject.GetComponent<Transform>().rotation = Quaternion.Euler(rotationVector);
        this.gameObject.GetComponent<Transform>().position = GameObject.Find("Torso_RB").transform.position;
