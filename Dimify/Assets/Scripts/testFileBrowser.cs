...
public class testFileBrowser : MonoBehaviour {
	...
	public void OnGUI()
	{
		int FileBrowserDisplay = PlayerPrefs.GetInt ("FileBrowserDisplay");

		if (FileBrowserDisplay == 1) 
		{
				...
				else 
				{
                    ...
                    PlayerPrefs.SetString("FileBrowserPath", fb.outputFile.FullName.ToString());
					PlayerPrefs.SetInt("FileBrowserDisplay",0);
				}
			}
			}
