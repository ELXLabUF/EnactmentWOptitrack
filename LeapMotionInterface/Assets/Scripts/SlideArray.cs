...
public class SlideArray : MonoBehaviour
{
    ...
    public void addSlideAlone()
    {
        ...
        GameObject.FindGameObjectWithTag("all_canvases").GetComponent<CanvasManager>().addSlideHide();
    }

    public void addSlide()
    {
        
        if (GameObject.Find("SlideSections").GetComponent<SlideNumbering>().getCondition() == 1 || GameObject.Find("SlideSections").GetComponent<SlideNumbering>().getCondition() == 2 || GameObject.Find("SlideSections").GetComponent<SlideNumbering>().getTotal() == 0)
        {
            if (slideBase != null && currentListID < 5)
            {
        ...
        else if(GameObject.Find("SlideSections").GetComponent<SlideNumbering>().getAddReady() == true)
        {
            ...
            GameObject.FindGameObjectWithTag("all_canvases").GetComponent<CanvasManager>().addSlidePop();
        }
        else
        {
            GameObject.FindGameObjectWithTag("all_canvases").GetComponent<CanvasManager>().addingIncompletePop();
        }
