...
/*Script to attach to slide prefab*/
public class SlideSelectSlide : MonoBehaviour, IPointerClickHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    //function for decreasing slide id when a slide ordered before it is deleted - see SlideArray
    ...
    public void deleteMe()
    {
        ...
        this.GetComponentInParent<SlideArray>().renumberSlidesDelete(listID); //called to reorder slides affected by this slide being deleted
    ...
    public void selectMe()
    {
        ...
        if (GetComponentInParent<SlideArray>().GetComponentInParent<SlideNumbering>() != null)
        {
            GetComponentInParent<SlideArray>().GetComponentInParent<SlideNumbering>().selectNew(whichSection, listID);
        }
        else
        {
    ...
    public void OnPointerEnter(PointerEventData data)
    {
        ...
        if (GetComponentInParent<SlideArray>().getSlideMoving() == true && moving == false)
        {
            this.GetComponentInParent<SlideArray>().setSlideMovingHover(true, listID);
