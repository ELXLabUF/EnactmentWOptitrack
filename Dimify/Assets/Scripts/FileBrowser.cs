...
//Protected	
	...
	//DIME Change
	#else
		public FileBrowser(string directory,int layoutStyle):this(directory,layoutStyle,new Rect(Screen.width*0.05f,Screen.height*0.25f,Screen.width*0.9f,Screen.height*0.75f)){}
